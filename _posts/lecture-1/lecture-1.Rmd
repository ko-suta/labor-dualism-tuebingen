...
- <span style="color:darkred">financial</span>: widening payment differentials between skilled and unskilled workers `r fa("arrow-alt-circle-right", fill = "#cc0033")` assessment-based system facilitating numerical and functional flexibility `r Citep(myBib, "atkinson1984manpower", .opts = list(cite.style = "authoryear", style = "html"))`
