...
Majority of changes in employment protection took place **at the margin** `r fa("arrow-alt-circle-right", fill = "#cc0033")` favours the creation of **segmented labour markets** `r fa("arrow-alt-circle-right", fill = "#cc0033")` employees with atypical contracts carry the burden of adjustment to economic shocks `r fa("arrow-alt-circle-right", fill = "#cc0033")` more precarious employment, lack of adequate provision of training for those with atypical contracts and negative impacts on productivity.
