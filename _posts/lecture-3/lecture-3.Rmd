...
1990 -- 2000: 
 ...
 - short-term employment grew by 60 percent; 
 
 - trainees, recipients of special contracts via public financing: + 65 \%; 
 
 - temporary employment grew by 130 percent;
...
1988: RMI (*Revenu Minimum d’Insertion*):
 ...
 - easing cuts in the unemployment insurance system `r fa("arrow-alt-circle-right", fill = "#cc0033")` from insurance benefits `r fa("arrow-alt-circle-right", fill = "#cc0033")` to **social assistance**
...
From 1998 onward:
 ...
 - **sharper line** between those supported by insurance funds and on a contributory basis and those on state-financed, income-tested assistance;
 - Harz reforms
...
**Harz IV**:
 ...
 - removing middle tier of unemployment assistance `r fa("arrow-alt-circle-right", fill = "#cc0033")` merging this with **social assistance** `r fa("arrow-alt-circle-right", fill = "#cc0033")`;
 - exhausting unemployment insurance benefits `r fa("arrow-alt-circle-right", fill = "#cc0033")` flat-rate income-tested social assistance `r fa("arrow-alt-circle-right", fill = "#cc0033")`;
